...
async function joinRoomInit() {
    ...
    getMembers()
    addBotMessagetoDom(`Welcome to the chat-room of mumble, ${displayName}! 
                                           ⢀⣴⣿⣿⣿⣿⣶⣦⡀⠀⠀⠀⠀⠀⠀⠀
                            ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣻⣿⣿⣿⣿⣿⢥⣛⣿⣷⠀⠀⠀⠀⠀⠀⠀
                            ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠴⣿⣿⣿⣿⣯⢻⠿⣏⣿⣿⠆⠀⠀⠀⠀⠀⠀
                            ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠘⣿⣿⣿⣿⣿⣿⣇⡟⣧⣿⣿⡇⠀⠀⠀⠀⠀⠀
...
async function handleUserPublished(user, mediaType) {
    ...
    if(displayFrame.style.display) {
        ...
        videoFrame.style.height = "85px"
        videoFrame.style.width = "85px"
    }
...
let toggleScreen = async(e) => {
    ...
    if(!sharingScreen) {
        ...
        localScreenTracks = await AgoraRTC.createScreenVideoTracks()
